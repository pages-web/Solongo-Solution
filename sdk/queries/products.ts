...
// type GetPricingPlans = (params?: CommonParams) => Promise<{
//   pricingPlans: any[];
//   error_msg: string | undefined;
// }>;
...
// export const getSalesProducts: GetPricingPlans = cache(async (params) => {
//   const { data, error } = await getClient().query({
//     query: queries.getSalesProducts,
//     variables: params?.variables,
//   });
//   const { pricingPlans } = data || {};
//   return {pricingPlans , error_msg: error?.message };
// });
